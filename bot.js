...
client.on("message", msg => {
  if (msg.content.toLowerCase() === prefix + "davet") {
    msg.reply("https://discord.gg/5UGy7ptMgg");
  }
  ...
  if (msg.content.toLowerCase() ===  "<@689338408593653810>") {
    msg.channel.send("Çağrı yok ben yardımcı olayım.");
  }
});
...
client.elevation = message => {
  ...
  let permlvl = 0;
  if (message.member.hasPermission("MANAGE_NICKNAMES")) permlvl = 2;
